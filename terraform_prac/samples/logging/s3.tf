# CloudWatch Logs 永続化バケット
resource "aws_s3_bucket" "cloudwatch_logs" {
  bucket = "cloudwatch-logs-pragmatic-terraform-kokoichi"
...
# Kinesis Data Firehose IAM ロールのポリシードキュメント
...
# 配信ストリーム（Kinesis Data Firehose -> S3）の定義
...
# Kinesis Data Firehose 操作権限と PassRole 権限
